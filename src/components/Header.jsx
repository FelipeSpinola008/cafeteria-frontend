    ...
    <header className="flex items-center justify-between bg-transparent pl-16 pr-20 pt-12 ">
      <div className="flex justify-between font-playfair text-white text-4xl font-bold"> 
        <div className="flex items-baseline gap-8">
          <a href="#Hero">CoffeeDev</a>
          <nav className="flex items-baseline gap-8 font-poppins text-white text-base font-light ">
            <a className='hover:text-white-coffee transition-colors cursor-pointer'
            onClick={() => document.getElementById('products')?.scrollIntoView({ behavior: 'smooth' })}>CAFÉS</a>
            <a href="" className='hover:text-white-coffee transition-colors'>SOBRE</a>
            <a className='hover:text-white-coffee transition-colors cursor-pointer' onClick={() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth'})}>CONTATO</a>
          </nav>
        </div>  
      </div> 
        <div className="flex items-center gap-10 font-poppins text-white text-base font-light">  
          ...
          <a href="" className='hover:text-white-coffee transition-colors'><Heart size={22} strokeWidth={1.5}/></a>
